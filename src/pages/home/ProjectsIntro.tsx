    ...
    <section className="min-h-screen bg-seashell-100 text-coffee-900 flex items-center">
      <div className="layout-grid grid grid-cols-12 gap-4 md:gap-6 py-24">
        <div className="col-span-12 md:col-span-7">
          <p className="font-space-mono text-xs uppercase tracking-[0.25em] text-coffee-500 mb-4">
            <AnimatedText text={t("home.projectsIntro.label")}>
              {t("home.projectsIntro.label")}
            </AnimatedText>
          </p>
          <h2 className="font-urbanist text-4xl md:text-6xl lowercase text-avocado-700 text-glow mb-4">
          ...
          <AnimatedText text={t("home.projectsIntro.cta")}>
            <button
              ...
              className="inline-flex items-center px-8 py-3 rounded-full border border-seashell-300/60 bg-coffee-200/40 hover:bg-coffee-400/40 text-sm font-space-mono tracking-[0.2em] uppercase cursor-pointer
