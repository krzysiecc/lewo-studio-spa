...
const useResizeObserver = (
  ...
  useEffect(() => {
    ...
    // Note: elements is a stable array of refs, and callback is wrapped in useCallback in the parent
  }, [callback, elements]);
};
...
export const LogoLoop = React.memo<LogoLoopProps>(
  ({
    ...
    // Use specific refs instead of dependencyList to satisfy exhaustive-deps
